package co.kr.mrs.store.web.rest;

import co.kr.mrs.store.HipsterstoreApp;
import co.kr.mrs.store.domain.Authority;
import co.kr.mrs.store.domain.User;
import co.kr.mrs.store.repository.AuthorityRepository;
import co.kr.mrs.store.repository.UserRepository;
import co.kr.mrs.store.security.AuthoritiesConstants;
import co.kr.mrs.store.service.MailService;
import co.kr.mrs.store.service.UserService;
import co.kr.mrs.store.service.dto.UserDTO;
import co.kr.mrs.store.web.rest.vm.ManagedUserVM;
